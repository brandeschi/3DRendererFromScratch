...
This codebase is the result of working through the following course: [3D Computer Graphics Programming](https://pikuma.com/courses/learn-3d-computer-graphics-programming). This is a **_software renderer_** which means it does not utilize any graphical APIs like OpenGL. The core concepts taught in the course have been implemented. The models used in the course have not been included as I do not own them, but the renderer works with most Wavefront OBJ file. I might update how models and textures are loaded into the program at a future date.
